...
module.exports = "<div class=\"container\">  <!-- use div to create module -->\n  <app-new-problem></app-new-problem>\n  <div class=\"list-group\">\n    <a class=\"list-group-item\" *ngFor=\"let problem of problems\" [routerLink] = \"['/problems', problem.id]\">  <!--和router进行绑定-->\n      <span class=\"{{'pull-left label difficulty diff-' + problem.difficulty.toLocaleLowerCase()}}\">\n        {{problem.difficulty}}\n      </span>\n      <strong class=\"title\">{{problem.id}}. {{problem.name}}</strong>\n    </a>\n  </div>\n</div>\n"
...
var DataService = /** @class */ (function () {
    function DataService(httpClient) {
        ...
        this._problemSource = new rxjs__WEBPACK_IMPORTED_MODULE_2__["BehaviorSubject"]([]); //希望可以拿到problem的一个数组
    }
...
module.exports = __webpack_require__(/*! /Users/peiyuanli/Desktop/TigerProject/Collaborative Online Judge System /week1/oj-client/src/main.ts */"./src/main.ts");
